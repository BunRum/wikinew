...
import { Grid, Card, Table } from "@nextui-org/react";
      ...
      <Grid xs={8}>
        <Card variant="bordered">
          <Card.Body>
            ...
            <h2 id="image-resolutions"><strong>Image Resolutions</strong></h2>
            ...
            <p> <a href="https://cdn.discordapp.com/attachments/565625878831169546/662005932871516170/Complete_GUI_Assets.zip">GUI</a></p>
            <p><sub>By GhostWaves</sub></p>
            <h2 id="templates"><strong>Templates</strong></h2>
            <p><img src="https://cdn.discordapp.com/attachments/655235083745230848/733111487593316392/card_XXXXsp_cutin_1.png" width="350" alt='cutin' /></p>
            <p><img src="wikinew/files/images/piecetemplate.png" width="100" alt='piece' /></p>
            <p><img src="wikinew/files/images/circletemplate.png" width="100" alt='circle' /></p>
            <p><img src="wikinew/files/images/thumbtemplate.png" width="150" alt='thumb' /></p>
            <p><sub>By BunRum</sub></p>
            <hr />
            ...
            <pre>
            <code>-<span class="ruby"> black
              <br/>
              </span>-<span class="ruby"> blue
              <br/>
              </span>-<span class="ruby"> gold (original frame)
              <br/>
              ...
              <br/>
              </span>-<span class="ruby"> rainbow
              </span>
            </code>
            </pre><p><a href="https://cdn.discordapp.com/attachments/655235083745230848/753044679586480178/TEMPLATE_ZIP.zip">Download Link of the ZIP</a></p>
